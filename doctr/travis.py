...
def setup_GitHub_push(deploy_repo, auth_type='deploy_key', full_key_path='github_deploy_key.enc', no_require_master=False):
    """
    ...
    if TRAVIS_BRANCH != "master" and no_require_master:
        print("The docs are only pushed to gh-pages from master. To force pushing from "
